                            ...
                            <div class="p-4">
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea name="description" id="description"
                                        class="w-full p-4 mt-2 bg-white border rounded-lg shadow-md border-cyan-200 focus:outline-none focus:border-slate-300 focus:shadow-cyan-200 focus:ring-cyan-300 focus:ring-1">{{ old('description') }}</textarea>
                                    @error('description')
                                    <p class="mt-0.5 text-sm italic text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
